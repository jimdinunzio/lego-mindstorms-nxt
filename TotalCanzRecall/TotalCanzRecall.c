#pragma config(UserModel, "C:/Users/jim/Documents/git/lego-mindstorms-nxt/TotalCanzRecall/TotalCanzRecallModel.h")
...
const int DistCloseEnoughForNoCorrection = 400;
...
;
	driveRobotStraightInMm(150); // get out of white area
	while (1)
	{
		...
		if (findClosestTarget(distToClosestTarget, angleToClosestTarget))
		{
			...
			{
				writeDebugStreamLine("distance to target is > threshold, driving part way to it and scanning again.");
				...
				driveRobotStraightInMm(distToClosestTarget - DistCloseEnoughForNoCorrection);
